	...
	\begin{columns}[T]
		\begin{column}{0.5\textwidth}
			\begin{block}{}
				\begin{itemize}
					...
					\begin{itemize}
						\item<2-> \textbf{Exactly 1 electron or muon}{\tikz[remember picture]{\node[coordinate] (s-lepton) {};}} passing the trigger and quality criteria
						\begin{itemize}
						...
						\end{itemize}
						\item<4-> \textbf{Must contain some \ETslash}{\tikz[remember picture]{\node[coordinate] (s-met) {};}}
						\begin{itemize}
		...
		\begin{column}{0.445\textwidth}
			...
			\begin{tikzpicture}[remember picture]
				...
				\only<1-4>{\node [inner sep=0pt,above right] {\includegraphics[width=\textwidth]{\figpath/FeynmanDiagrams/ggH_WW_lvjj.pdf}};}
				\only<5->{\node [inner sep=0pt,above right] {\includegraphics[width=\textwidth]{\figpath/FeynmanDiagrams/TTbar.pdf}};}
				%\only<6->{
...
\begin{frame}
	...
	\begin{table}[tb]
		...
		\begin{tabular}{>{\centering}m{0.15\textwidth} >{\centering}m{0.27\textwidth} | >{\centering}m{0.15\textwidth} >{\centering\arraybackslash}m{0.27\textwidth}}
			\Wjets & \includegraphics[width=0.25\textwidth]{\figpath/FeynmanDiagrams/WJets.pdf} & \WW & \includegraphics[width=0.25\textwidth]{\figpath/FeynmanDiagrams/WW.pdf} \\
			\WZ & \includegraphics[width=0.25\textwidth]{\figpath/FeynmanDiagrams/WZ.pdf} & & \\
		\end{tabular}
	\end{table}
	\vspace*{-0.2cm}
	\begin{itemize}
	...
	\begin{table}[tb]
		\centering
		\begin{tabular}{>{\centering}m{0.15\textwidth} >{\centering}m{0.27\textwidth} | >{\centering}m{0.15\textwidth} >{\centering\arraybackslash}m{0.27\textwidth}}
			  \ttbar & \includegraphics[width=0.25\textwidth]{\figpath/FeynmanDiagrams/TTbar.pdf} & & \\
		\end{tabular}
	\end{table}
\end{frame}
...
\begin{frame}
	...
	\begin{table}[tb]
		\centering
		\begin{tabular}{>{\centering}m{0.15\textwidth} >{\centering}m{0.27\textwidth} | >{\centering}m{0.15\textwidth} >{\centering\arraybackslash}m{0.27\textwidth}}
			\Zjets & \includegraphics[width=0.25\textwidth]{\figpath/FeynmanDiagrams/ZJets.pdf} & \ZZ & \includegraphics[width=0.25\textwidth]{\figpath/FeynmanDiagrams/ZZ.pdf} \\
			Single-\cPqt\\(\cPqs-channel) & \includegraphics[width=0.25\textwidth]{\figpath/FeynmanDiagrams/STopS.pdf} & Single-\cPqt\\(\cPqt-channel) & \includegraphics[width=0.25\textwidth]{\figpath/FeynmanDiagrams/STopT.pdf} \\
			Single-\cPqt\\(\cPqt\PW-channel) & \includegraphics[width=0.25\textwidth]{\figpath/FeynmanDiagrams/STopTW.pdf} & QCD & \includegraphics[width=0.25\textwidth]{\figpath/FeynmanDiagrams/QCD.pdf}\\
		\end{tabular}
	\end{table}
\end{frame}