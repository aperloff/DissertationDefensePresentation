	...
	%\begin{alertblock}{}
		\begin{myfancyblock}
    		\node[anchor=south west,inner sep=0] (image) at (0,0) {%
    		   \hspace*{0.15cm}\includegraphics[width=0.26\textwidth]{\figpath/BDTTemplates/KinMEBDT_jets2_electron.pdf}%
    		   \hspace*{0.15cm}\includegraphics[width=0.26\textwidth]{\figpath/BDTTemplates/KinMEBDT_jets3_electron.pdf}%
    		   \hspace*{0.15cm}\includegraphics[width=0.26\textwidth]{\figpath/BDTTemplates/KinMEBDT_jets4_electron.pdf}%
    		};
    		\node[anchor=south west,inner sep=0] (image2) at (0,-4.1) {%
    		   \hspace*{0.15cm}\includegraphics[width=0.26\textwidth]{\figpath/BDTTemplates/KinMEBDT_jets2_muon.pdf}%
    		   \hspace*{0.15cm}\includegraphics[width=0.26\textwidth]{\figpath/BDTTemplates/KinMEBDT_jets3_muon.pdf}%
    		   \hspace*{0.15cm}\includegraphics[width=0.26\textwidth]{\figpath/BDTTemplates/KinMEBDT_jets4_muon.pdf}%
    		};

    		\node [draw,rectangle,text centered, rounded corners,fill=tamugray,tamumaroon!30,text=Black,rotate=90, left of = image, xshift=1.1cm, yshift=5.5cm] {Electron};
    		\node [draw,rectangle,text centered, rounded corners,fill=tamugray,tamumaroon!30,text=Black,rotate=90, left of = image2, xshift=1.1cm, yshift=5.5cm] {Muon};
  		\end{myfancyblock}
