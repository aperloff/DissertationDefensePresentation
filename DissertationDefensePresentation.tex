...
\frame {
    \vspace{-0.4cm}
    \begin{center}
        \makebox[0pt][l]{\includegraphics[width=0.50in]{figures/TAMULogoMaroonBox.jpg}}\hfill%
        \makebox[0pt][r]{\includegraphics[width=0.50in]{figures/CMS_exp.png}}
    \end{center}
    \vspace{-0.8cm}
    \titlepage
}
...
{
\usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight]{\figpath/cms-image1112.jpg}}%
